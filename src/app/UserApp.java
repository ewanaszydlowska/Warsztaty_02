...
public class UserApp {
	...
	public static void main(String[] args) {
		...
		try {
			Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/warsztat2?useSSL=false", "root", "coderslab");
...
//				System.out.println(newUser.getId() + newUser.getUsername() + newUser.getEmail() + newUser.getPassword() + newUser.getUserGroupId());
//			}
